# Trade and Security over the Spilhaus World Ocean Map 
...
While NATO still covers the two most important oceans for trade routes; China has gained influence over the Strait of Malacca, a critical chokepoint, as well as over the at-times critical contour of Western Africa. This data could now be used to create an index on the influence of different country groups over trade. A potential fragmentation of NATO could lead to different zones of influence over the world's oceans. How would European countries fare in a contentious and fragmented security system over oceans? What would be neccessary for Europe to provide security to the chokepoints, routes and ports that are critical to its trade? 
